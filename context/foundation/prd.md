...
- **Structural edit.** Changing a habit's modality or frequency resets the current streak to zero (FR-007). Historical streaks (and therefore the top-10 best-streaks view) are **not** modified by edits — they reflect what the user actually achieved at the time, under the historical configuration.
